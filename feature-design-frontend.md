...
### 1. Books Management
- Filter by All, Most Recent Day, Status (including Without LOC), and a bottom Pricing section (Books with Pricing, Books without Pricing; price older than N days, default 90)
- CRUD operations
- Bulk delete
