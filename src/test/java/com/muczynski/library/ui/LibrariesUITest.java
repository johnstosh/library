...
public class LibrariesUITest {
    ...
    void testLibrariesCRUD() {
        try {
            ...
            table.waitFor(new Locator.WaitForOptions().setTimeout(20000L));
            assertThat(table).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(20000L));

            // Wait for library section to be interactable, focusing on form
            page.waitForSelector("[data-test='new-library-name']", new Page.WaitForSelectorOptions().setTimeout(20000L).setState(WaitForSelectorState.VISIBLE));
            ...
            // Wait for the operation to complete - network idle ensures POST + GET completes
            page.waitForLoadState(LoadState.NETWORKIDLE, new Page.WaitForLoadStateOptions().setTimeout(20000L));

            // Wait for button to reset to "Add Library" after creation
            Locator addButton = page.locator("[data-test='add-library-btn']");
            assertThat(addButton).hasText("Add Library", new LocatorAssertions.HasTextOptions().setTimeout(20000L));
            ...
            libraryItem.first().waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE).setTimeout(20000L));
            assertThat(libraryItem.first()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(20000L));
            assertThat(libraryItem).hasCount(1, new LocatorAssertions.HasCountOptions().setTimeout(20000L)); // Only new
            assertThat(libraryList).hasCount(2, new LocatorAssertions.HasCountOptions().setTimeout(20000L)); // Initial + new
            // Assert the name is in the library-name span
            assertThat(libraryItem.first().locator("[data-test='library-name']")).hasText(uniqueName + " (" + uniqueHostname + ")", new LocatorAssertions.HasTextOptions().setTimeout(20000L));
            ...
            assertThat(addButton).hasText("Update Library", new LocatorAssertions.HasTextOptions().setTimeout(20000L));
            ...
            // Wait for the operation to complete - network idle ensures PUT + GET completes
            page.waitForLoadState(LoadState.NETWORKIDLE, new Page.WaitForLoadStateOptions().setTimeout(20000L));
            ...
            updatedLibraryItem.first().waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE).setTimeout(20000L));
            assertThat(updatedLibraryItem.first()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(20000L));
            // Assert the updated name is in the library-name span
            assertThat(updatedLibraryItem.first().locator("[data-test='library-name']")).hasText(updatedName + " (" + uniqueHostname + ")", new LocatorAssertions.HasTextOptions().setTimeout(20000L));
            ...
            assertThat(oldLibraryItem).hasCount(0, new LocatorAssertions.HasCountOptions().setTimeout(20000L)); // Test item removed
            ...
            // Wait for the operation to complete - network idle ensures DELETE + GET completes
            page.waitForLoadState(LoadState.NETWORKIDLE, new Page.WaitForLoadStateOptions().setTimeout(20000L));
            ...
            assertThat(deletedCheck).hasCount(0, new LocatorAssertions.HasCountOptions().setTimeout(20000L));
            assertThat(libraryList).hasCount(1, new LocatorAssertions.HasCountOptions().setTimeout(20000L));
