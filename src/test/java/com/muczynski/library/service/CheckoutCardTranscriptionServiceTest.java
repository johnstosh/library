...
public class CheckoutCardTranscriptionServiceTest {
    ...
    void testTranscribeCheckoutCard_success() throws Exception {
        ...
        when(askGrok.analyzePhoto(eq(imageBytes), eq(contentType), anyString(), anyString(), isNull(), eq(AskGrok.IMAGE_DETAIL_HIGH)))
        ...
        verify(askGrok).analyzePhoto(eq(imageBytes), eq(contentType), anyString(), anyString(), isNull(), eq(AskGrok.IMAGE_DETAIL_HIGH));
    }
